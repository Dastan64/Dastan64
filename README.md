...
My name is Dastan, let's get acquainted.

Repositories with the word "project" = sites that were created by me personally. This was done for faster browsing of sites, in which you only need to change the number.

Repositories with other names = JavaScript/React projects.
